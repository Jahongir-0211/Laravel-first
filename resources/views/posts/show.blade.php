    ...
    <div class="blog-title-area">
      <ol class="breadcrumb hidden-xs-down">
        ...
        <li class="breadcrumb-item"><a
            href="{{ route('categories.single', $post->category->slug) }}">{{ $post->category->title }}</a></li>
    ...
    <div class="custombox authorbox clearfix">
      ...
      <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
          ...
          <p>Quisque sed tristique felis. Lorem <a href="#">visit my website</a> amet, consectetur adipiscing elit.
            Phasellus quis mi auctor, tincidunt nisl eget, finibus odio. Duis tempus elit quis risus congue feugiat.
            Thanks for stop Markedia!</p>
          ...
          <div class="comments-list">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p>Exercitation photo booth stumptown tote bag Banksy, elit small batch freegan sed. Craft beer elit
                  ...
                  delectus, Marfa eiusmod Pinterest in do umami readymade swag. Selfies iPhone Kickstarter, drinking
                  vinegar jean.</p>
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p>Drinking vinegar stumptown yr pop-up artisan sunt. Deep v cliche lomo biodiesel Neutra selfies. Shorts
                  fixie consequat flexitarian four loko tempor duis single-origin coffee. Banksy, elit small.</p>
            ...
            <div class="media last-child">
              ...
              <div class="media-body">
                ...
                <p>Kickstarter seitan retro. Drinking vinegar stumptown yr pop-up artisan sunt. Deep v cliche lomo
                  biodiesel Neutra selfies. Shorts fixie consequat flexitarian four loko tempor duis single-origin coffee.
                  Banksy, elit small.</p>
